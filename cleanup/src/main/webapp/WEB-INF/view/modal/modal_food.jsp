...
<%@ taglib prefix="fm" uri="http://java.sun.com/jsp/jstl/fmt" %>  
	...
	<div class="food_modal modal">
		...
		<div class="modal_box" >
	        ...
	        <h2 class="menu_name">세탁 서비스</h2>
	        <div class="menu_dec"></div>
	        <div class="price"><span>비용</span><span class="menu_price" >0</span></div>
		...
		<div id="btn_box">
			...
			<div>
			<div class="min_delevery">기본의뢰금액 <fm:formatNumber value="${store.storeInfo.minDelevery }" pattern="###,###" />원 </div>
            <div class="sum"><span>총 의뢰금액</span><span class="total_price">0</span></div>
            </div>
          		
       		<button class=closeB type="button">취소</button>
       		<button class="add_cart" type="button">세탁소로 보내기 </button>
        </div>
	</div>
