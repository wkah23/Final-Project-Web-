	...
	<ul>
				...
				<ul>
					...
					<c:forEach begin="0" end="${fn:length(cart) -1 }" var="j"  >
						<li>
							...
							<div class="price">ㆍ배달비 <fm:formatNumber value="${cart[j].foodPrice }"  pattern="###,###" />원</div>
		...
		<li>
			<h2>결제수단</h2>
				...
				<label><input type="radio" value="현장결제" name="payMethod">현금결제</label>
			<hr>
		</li>
		...
		<li class="pay">
			<div class="order_price">세탁 의뢰 비용 : <fm:formatNumber value="${cartList.cartTotal }"  pattern="###,###" />원</div>
			<div>세탁소 할인 이벤트 : <fm:formatNumber value="${cartList.deleveryTip }"  pattern="###,###" />원 </div> 
